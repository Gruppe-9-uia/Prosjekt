...
CREATE TABLE IF NOT EXISTS Address_Code (
    Address_code_int INTEGER PRIMARY KEY,
    PostalCode_str VARCHAR(50),
    City_str VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS Customer (
    CustomerID_int INTEGER PRIMARY KEY,
    FirstName_str VARCHAR(50),
    LastName_str VARCHAR(50),
    Phone_str VARCHAR(50),
    Email_str VARCHAR(50),
    Street_Address_str VARCHAR(50),
    Address_code_int INTEGER,
    FOREIGN KEY (Address_code_int) REFERENCES Address_Code(Address_code_int)
);
...
CREATE TABLE IF NOT EXISTS Department (
	DepartmentID_int INTEGER PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS Employee (
    ...
    PRIMARY KEY(ID_int),
    FOREIGN KEY(DepartmentID_int) REFERENCES Department(DepartmentID_int)
);

-- Service_orderSQL og Serivce_formSQL:
...
CREATE TABLE IF NOT EXISTS Checklist (
	...
	Hydraulic_block ENUM('Ok', 'Skiftes', 'Defekt'),
    ...
    Cluth_Plate ENUM('Ok', 'Skiftes', 'Defekt'),
    ...
    Pg_test_radio ENUM('Ok', 'Skiftes', 'Defekt'),
    EOil_gearbox ENUM('Ok', 'Skiftes', 'Defekt'),
    Button_box ENUM('Ok', 'Skiftes', 'Defekt'),
