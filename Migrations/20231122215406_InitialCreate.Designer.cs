...
namespace Prosjekt.Migrations
{
    ...
    [Migration("20231122215406_InitialCreate")]
            ...
            modelBuilder.Entity("Prosjekt.Entities.ServiceOrderServiceformModel", b =>
                {
                    ...
                    b.Property<string>("checklistSerialNr_str")
                        .IsRequired()
                        .HasColumnType("varchar(100)");
                    ...
                    b.HasIndex("checklistDocID_str", "checklistSerialNr_str");
            ...
            modelBuilder.Entity("Prosjekt.Entities.ServiceOrderServiceformModel", b =>
                {
                    ...
                    b.HasOne("Prosjekt.Entities.ChecklistModel", "checklist")
                        .WithMany()
                        .HasForeignKey("checklistDocID_str", "checklistSerialNr_str")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
