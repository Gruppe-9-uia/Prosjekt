    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentModel", x => x.ID_int);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_DepartmentModel_DepartmentID_int",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Service_ordre_Customer_Product_CustomerProductCustomerID_int~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Service_ordre_CustomerProductCustomerID_int_CustomerProductS~",
                table: "Service_ordre",
                columns: new[] { "CustomerProductCustomerID_int", "CustomerProductSerialNr_str" });
